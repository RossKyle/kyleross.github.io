...
Écrivez un constructeur qui prend en paramètre le nom, salaire en nombre d'années d'expérience initial en paramètre.
...
### B
Écrivez une fonction `logEmploye(...)` qui prend en paramètre un employé et affiche, dans la console, tous les noms de ses propriétés avec leur valeur associée.
