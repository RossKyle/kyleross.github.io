...
### Exercice
Écrivez une fonction `creerBoutons` qui prend en paramètre un tableau et une `string`. Pour le bon fonctionnement de la fonction, le tableau doit contenur des `string` et le deuxième paramètre doit être l'id d'un élément du DOM.
