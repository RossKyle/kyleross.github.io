...
## Les méthodes
Une méthode d'un objet représente un comportement ou une action que l'objet peut faire. En réalité, les méthode sont des fonctions.
...
Le but d'un constructeur est de donner un état initial aux nouvels objet construit. Ceci implique d'affecter les attributs du nouvel objet avec des valeurs sensées.
...
* Construire un objet qui représente un rectangle implique de définir ses dimensions initiaux.
