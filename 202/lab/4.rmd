...
* Récupérer le projet de départ [ici](Labo4_départ);
...
* `ToString()` doit retourner une chaine formatter de la façon suivante :
```
PV:0
ATK:0
DEF:0
...
* un attribut `Vector2i directionPatrouille` qui indique la direction que l'ennemi se déplace lors de son patrouillage.
