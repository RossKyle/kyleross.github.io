...
Une fonction devrait réaliser une seule tâche dont celle décrite pas son nom. Le nom de la fonction **doit commencer par un verbe**, car une fonction réalise une action. Si c'est difficile de nommer votre fonction, elle devrait surement être divisée en plusieurs fonctions qui sont plus simples et donc facile à nommer.
