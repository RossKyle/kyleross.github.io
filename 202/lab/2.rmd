...
* `ChercherItem(...)` qui prend en paramètre l'indice de l'item à retourner. Assurez-vous de ne pas retourner `null`, par contre. Aussi, il n'est pas nécessaire de valider si l'indice est hors borne.
