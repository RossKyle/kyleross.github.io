...
## Travail à faire
Compléter le projet de départ aux endroit indiqués. La majorité du travail se retrouve dans la méthode `LireImage()` de la classe `Client`.

# Partie B
À venir...

# Remise
La date de remise est à déterminer. Celle-ci serait, au plus tôt, le 16 avril.
