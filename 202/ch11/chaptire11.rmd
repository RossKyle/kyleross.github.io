...
La structure de donnée à choisir pour contenir les noms des journées de la semaine devrait être un tableau classique, tandis que celle à choisir pour contenir toutes les touches pressées par l'utilisateur pendant un jeu est un tableau dynamique.
